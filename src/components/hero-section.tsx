        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative hidden lg:block">
            ...
            <div className="relative aspect-square w-full max-w-lg mx-auto">
              ...
              <div className="absolute inset-8 rounded-full bg-gradient-to-br from-accent/20 to-cool-blue/20 backdrop-blur-sm border border-white/30 flex items-center justify-center shadow-2xl">
                <div className="text-center space-y-3 p-6">
                  <div className="w-16 h-16 bg-gradient-to-br from-accent to-cool-blue rounded-2xl mx-auto flex items-center justify-center mb-4">
                    <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
                    </svg>
                  </div>
                  <p className="font-bold text-xl">Rapid Recruitment</p>
                  <p className="text-sm max-w-[200px] mx-auto text-muted-foreground">Our specialized focus delivers top biotech talent in record time</p>
                </div>
              </div>
              ...
              <div className="absolute -top-8 -left-8 bg-white/15 backdrop-blur-md border border-white/30 rounded-2xl p-4 shadow-xl animate-bounce [animation-duration:3s]">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <p className="font-semibold text-sm">Quality Match</p>
                    <p className="text-xs text-muted-foreground">Perfect fit guaranteed</p>
                  </div>
                </div>
              </div>
