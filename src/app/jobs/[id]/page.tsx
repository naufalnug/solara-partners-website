            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div>
                ...
                <div className="mt-6">
                  <Card>
                    <CardContent className="p-6">
                      <h3 className="font-bold mb-4">About {job.company}</h3>
                      <p className="text-muted-foreground">
                        {job.company} is an innovative biotech company focused on developing breakthrough therapies. Visit their website to learn more about their mission and culture.
                      </p>
