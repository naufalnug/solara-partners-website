                    ...
                    <div className="space-y-6">
                      <div className="flex items-start">
                        ...
                        <div>
                          ...
                          <p className="text-muted-foreground">123 Biotech Avenue</p>
                      ...
                      <div className="flex items-start">
                        ...
                        <div>
                          ...
                          <a href="mailto:info@solarapartners.com" className="text-muted-foreground hover:text-accent transition-colors">
