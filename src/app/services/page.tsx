            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="bg-accent/10 p-8 rounded-lg">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <div className="bg-background p-3 rounded border border-border">Research Scientists</div>
                  <div className="bg-background p-3 rounded border border-border">Lab Managers</div>
                  <div className="bg-background p-3 rounded border border-border">Bioinformaticians</div>
                  <div className="bg-background p-3 rounded border border-border">Process Development</div>
                  ...
                  <div className="bg-background p-3 rounded border border-border">Manufacturing</div>
                </div>
              </div>
            </div>
          </div>
