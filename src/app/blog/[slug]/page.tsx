  ...
  return (
    <>
      ...
      <main>
        ...
        <div className="aspect-[21/9] w-full bg-gradient-to-br from-accent/20 to-cool-blue/20 bg-cover bg-center"
             style={{backgroundImage: 'url("https://images.unsplash.com/photo-1551434678-e076c223a692?w=1200&h=500&fit=crop&crop=entropy&auto=format&q=80")'}} />
